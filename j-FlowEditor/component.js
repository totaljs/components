COMPONENT('floweditor', 'left:1;top:1;margin:0;right:0;bottom:0;zindex:30;language:eu;url:https://flow.totaljs.com;closebutton:1', function(self, config, cls) {
	...
	self.setter = function(value) {
		...
		self.append('<iframe src="{0}&language={1}&darkmode={2}&hideclose={3}&color={4}" scrolling="no" frameborder="0"></iframe>'.format(config.url + '/?socket=' + encodeURIComponent(value), config.language, $('body').hclass('ui-dark') ? 1 : 0, config.closebutton ? '0' : '1', encodeURIComponent(DEF.color)));
