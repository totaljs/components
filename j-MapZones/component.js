COMPONENT('mapzones', 'height:200;zoom:13;color:#fcba03;modify:1;opacity:20', function(self, config, cls) {
	...
	self.setstyle = function() {
		meta.style = {
			'fill-color': meta.color ? meta.color + config.opacity : config.color + config.opacity,
