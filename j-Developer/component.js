COMPONENT('developer', 'interval:1000;position:topleft', function(self, config, cls) {
	...
	self.process = function() {
		...
		var live = ['set', 'get', 'components', 'binders', 'setters', 'exec', 'requests', 'events', 'returns', 'cmd'];
