		...
		switch (name) {
			...
			case 'pluginspeak':
				...
				if (cache[k].peak == null || cache[k].peak !== perf.peak) {
					...
					span.eq(0).html((perf.peak || 0) + '/<i class="fa fa-long-arrow-up"></i>' + limits[name]);
